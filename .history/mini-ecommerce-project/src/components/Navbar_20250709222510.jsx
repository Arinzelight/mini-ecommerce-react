    ...
    <nav className="w-full bg-secondary-mint shadow-md sticky top-0 z-50 rounded-b-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center">
          <a href="/" className="flex items-center gap-2 text-primary hover:text-primary-light font-bold text-lg transition-colors duration-200">
        ...
        <div className="flex items-center space-x-6">
          ...
          <a href="/cart" className="hidden sm:relative sm:flex text-primary hover:text-primary-light transition-colors duration-200">
